...
```mermaid
flowchart LR
  Visitor["Visitor or buyer"] --> Site["AIXYZ public site"]
  Site --> Offers["Fiverr offer pages"]
  Site --> Demo["Public-safe demo"]
  Site --> Intake["Lead intake"]
  Intake --> Review["Owner review"]
  Review --> PrivateOps["Protected systems"]
  PrivateOps --> Receipts["Receipts and status"]
```
...
| --- | --- |
| AIXYZ homepage | ![AIXYZ homepage screenshot](assets/gallery/aixyz-home-desktop.png) |
| Brandi beauty-commerce demo | ![Brandi demo screenshot](assets/gallery/aixyz-brandi-demo-desktop.png) |
| Fiverr AI Receptionist offer | ![Fiverr AI Receptionist screenshot](assets/gallery/aixyz-fiverr-ai-receptionist-desktop.png) |
